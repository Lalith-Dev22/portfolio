    ...
    <>
      ...
      >
        <Button
          ...
          size="lg"
          className="w-14 h-14 rounded-full bg-sidebar/90 backdrop-blur-lg border border-sidebar-border hover:bg-sidebar-accent transition-all duration-300 p-0"
        >
              ...
              <div className="flex flex-col h-full">
                ...
                <div className="p-6 border-b border-sidebar-border">
                  ...
                  >
                    ...
                    <div>
                      <h2 className="text-lg font-bold text-sidebar-foreground">Portfolio</h2>
                    ...
                    {sections.map((section, index) => (
                      ...
                      >
                        <NavLink
                          ...
                          className={`flex items-center space-x-4 w-full p-4 rounded-xl transition-all duration-300 group ${
