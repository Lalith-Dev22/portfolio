...
export const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-background snap-y snap-mandatory" style={{ overflowY: 'auto' }}>
        ...
        >
          ...
          >
            <Button 
              ...
              size="lg"
              className="bg-gradient-primary hover:shadow-glow transition-all duration-500 hover:scale-105 text-sm sm:text-lg md:text-xl px-6 py-3 sm:px-8 sm:py-4 md:px-12 md:py-6 rounded-full font-semibold w-auto"
            >
