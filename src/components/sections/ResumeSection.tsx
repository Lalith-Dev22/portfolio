  ...
  experience: [
    {
      ...
      type: "Internship",
      description:
        "Built internal platforms for intern management and static sites during my full stack internship.",
      achievements: [
  ...
  projects: [
    {
      ...
      description:
        "A real-time intern time tracking tool with activity logging and reporting features.",
    ...
    },
    {
      ...
      description:
        "Internal tool for managing and resolving employee-raised tickets with comments and status.",
    ...
    },
    {
      ...
      description:
        "Static e-commerce showcase site using Firebase for dynamic product data handling.",
