  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <section className="min-h-screen flex items-center section-padding relative snap-start snap-always">
          ...
          <div className="w-full max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center min-h-[80vh]">
            ...
            >
              ...
              <motion.div
                ...
                className="inline-flex items-center gap-2 glass-card px-4 py-2 bg-primary/10 rounded-full mt-2"
              >
              ...
              <a href="/Lalith_resume.pdf" download>
                <motion.button
                  className="glass-card px-4 py-3 sm:px-6 sm:py-4 md:px-8 md:py-4 bg-primary text-primary-foreground font-semibold rounded-xl hover:bg-primary/90 transition-all duration-300 flex items-center justify-center gap-3 group relative overflow-hidden w-full sm:w-auto mt-4"
            ...
            <motion.img
              src={Image1}
              alt="Developer"
              className="w-full max-w-md sm:max-w-lg md:max-w-xl object-contain pointer-events-none drop-shadow-[0_0_20px_rgba(255,0,255,0.3)] transition-all duration-500 hover:drop-shadow-[0_0_35px_rgba(255,105,180,0.6)]"
            />
          </div>
        </section>
